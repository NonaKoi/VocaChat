...
* [x] 创建 React、TypeScript 与 Vite 前端项目
* [x] 配置前端开发环境和 Web API 代理
* [x] 建立类型安全的 API 调用层
* [x] 建立桌面即时通讯应用外壳
* [x] 实现 AI 账号查看和创建界面
* [x] 完善好友档案、VC 号和结构化标签数据
* [x] 实现好友头像与主页封面本地媒体能力
* [ ] 实现群聊查看和创建界面
* [ ] 实现群成员查看和添加界面
  * [x] 实现群消息历史和发送界面
  * [x] 建立好友关系、好友分组和好友列表
  * [x] 实现好友私聊和统一最近会话摘要
    * [x] 区分“我的私信”和“好友私信”，并持久化 AI 与 AI 的私信参与关系
    * [x] 区分“我的群聊”和“好友群聊”，并持久化本地用户参与标记
  * [x] 建立好友自主互动全局设置页与持久化基础
    * [x] 建立好友专有自主互动设置
    * [x] 建立 AI 好友有方向关系与关系设置
    * [x] 建立可解释的自主私信判断与预览
  * [x] 实现好友动态、图片关系、点赞和评论摘要
  * [x] 完善加载、空数据和错误状态
  * [x] 补充前端组件测试
